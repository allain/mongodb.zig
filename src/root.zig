/// A Zig client library for MongoDB, providing connection management,
/// CRUD operations, and BSON encoding/decoding.
pub const Client = @import("client.zig").Client;
pub const FindOpts = @import("client.zig").FindOpts;
pub const Connection = @import("connection.zig").Connection;
pub const ConnectOptions = @import("connection.zig").ConnectOptions;
